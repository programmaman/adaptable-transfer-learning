...
def run_synthetic_experiments():
    ...
    _, graphsage_cls_results, graphsage_lp_results = run_graphsage_pipeline(data, labels)

    print("\n========== [Synthetic] SimpleGAT ==========")
    _, simplegat_cls_results, simplegat_lp_results = run_gat_pipeline(data, labels)
    ...
    print(f"[SimpleGraphSAGE]   {graphsage_lp_results.summary()}")
    print(f"[SimpleGAT]         {simplegat_lp_results.summary()}")
...
def run_github_experiments(edge_path, features_path, target_path):
