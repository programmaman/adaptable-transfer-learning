...
class Trainer:
    ...
    def train(self, train_data, val_data, train_step_fn, train_validation_step_fn, epochs=50, log_interval=10):
        """
        ...
        Args:
            ...
            train_validation_step_fn: Function to compute validation loss.
        ...
        for epoch in range(epochs):
            ...
            # Validation Step
            val_loss = train_validation_step_fn(self.model, val_data, self.device)
